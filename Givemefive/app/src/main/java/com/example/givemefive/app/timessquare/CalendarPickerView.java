...
import com.example.givemefive.app.timessquare.MonthCellDescriptor.RangeState;
 ...
 * {@link com.example.givemefive.app.timessquare.CalendarPickerView.FluentInitializer} methods returned.  The currently selected date can be retrieved with
...
public class CalendarPickerView extends ListView {
   ...
   * <p>
   * This will implicitly set the {@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode} to {@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode#SINGLE}.  If you
   * want a different selection mode, use {@link com.example.givemefive.app.timessquare.CalendarPickerView.FluentInitializer#inMode(com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode)} on the
   * {@link com.example.givemefive.app.timessquare.CalendarPickerView.FluentInitializer} this method returns.
   * <p>
  ...
  public class FluentInitializer {
    /** Override the {@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode} from the default ({@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode#SINGLE}). */
     ...
     * pass in multiple dates and haven't already called {@link #inMode(com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode)}.
     */
  ...
  /**
   * Select a new date.  Respects the {@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode} this CalendarPickerView is configured
   * with: if you are in {@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode#SINGLE}, the previously selected date will be
   * un-selected.  In {@link com.example.givemefive.app.timessquare.CalendarPickerView.SelectionMode#MULTIPLE}, the new date will be added to the list of
   * selected dates.
   * <p>
   ...
   *
   * @see #setOnDateSelectedListener(com.example.givemefive.app.timessquare.CalendarPickerView.OnDateSelectedListener)
   */
   ...
   * listener will not be notified.
   *
   * @see #setOnInvalidDateSelectedListener(com.example.givemefive.app.timessquare.CalendarPickerView.OnInvalidDateSelectedListener)
   */
   ...
   *
   * @see #setDateSelectableFilter(com.example.givemefive.app.timessquare.CalendarPickerView.DateSelectableFilter)
   */
